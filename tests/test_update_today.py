...
def test_format_readings_html_with_title_only():
    ...
    result = format_readings_html(mass)
    assert '<h2 style="text-align: center; margin-bottom: 2rem;">Test Title</h2>' in result
...
def test_format_readings_html_full_mass():
    ...
    # Check Title
    assert '<h2 style="text-align: center; margin-bottom: 2rem;">Full Mass</h2>' in result
